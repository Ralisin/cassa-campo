...
<template>
  <div>
    ...
    <div class="dk-card dk-section">
      ...
      <PMessage v-if="actionError" severity="error" size="small" class="mb-3">{{ actionError }}</PMessage>
      <PMessage v-if="lastAction" severity="success" size="small" class="reimbursement-undo mb-3">
        {{ lastAction.message }}
